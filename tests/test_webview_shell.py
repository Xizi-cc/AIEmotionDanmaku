...
def test_webview_worker_puts_true_before_start(monkeypatch):
    ...
    nav_queue = MagicMock()
    _webview_worker("http://127.0.0.1:18765/", "AIEmotionDanmaku", "edgechromium", FakeReadyQueue(), nav_queue)
...
def test_webview_worker_start_error_puts_error(monkeypatch):
    ...
    _webview_worker("http://127.0.0.1:18765/", "AIEmotionDanmaku", None, FakeReadyQueue(), MagicMock())
