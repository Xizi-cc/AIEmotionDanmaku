...
`Boundary Guard` automates architecture rules from [CONTRIBUTING_ARCHITECTURE.md](CONTRIBUTING_ARCHITECTURE.md). It is **not** a general linter—it scans **git-changed** lines for AIEmotionDanmaku-specific regressions.
