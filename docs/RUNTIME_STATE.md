...
AIEmotionDanmaku keeps most mutable session data on `DanmuApp` in `main.py`. Newer code **projects** that data for Web and diagnostics instead of letting HTTP handlers read private fields.
