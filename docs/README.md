# AIEmotionDanmaku documentation
...
|----------|----------|-------------|
| [AI_PM_PRD.md](AI_PM_PRD.md) | Product / portfolio | AI PM-oriented PRD, metrics, roadmap, and resume-ready framing |
| [ARCHITECTURE.md](ARCHITECTURE.md) | Everyone | What AIEmotionDanmaku is, modules, threading, pipeline summary |
